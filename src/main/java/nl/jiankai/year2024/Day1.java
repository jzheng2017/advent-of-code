...
//        day1();
    ...
    private static void day2() {
        ...
        for (String s : split) {
            String[] num = s.split(" {3}");
            left.merge(Integer.parseInt(num[0]), 1, Integer::sum);
            right.merge(Integer.parseInt(num[1]), 1, Integer::sum);
        }

        int ans = 0;

        for (Map.Entry<Integer, Integer> entry : left.entrySet()) {
            ans += entry.getKey() * right.getOrDefault(entry.getKey(), 0);
        }
